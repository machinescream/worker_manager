...
typedef FutureOr<O> Fun5<A, B, C, D, E, O>(A arg1, B arg2, C arg3, D arg4, E arg5);

class Runnable<A, B, C, D, E, O> {
  final A arg1;
  final B arg2;
  final C arg3;
  final D arg4;
  ...
  call() {
    ...
    if (arg1 != null &&
        ...
        arg4 != null &&
        arg5 != null &&
        fun5 != null) return fun5(arg1, arg2, arg3, arg4, arg5);
  }
}
